...
/**
 * The test class NumberTheoryProblemsTest.
 *
 * @author  (your name)
 * @version (a version number or a date)
 */
public class NumberTheoryProblemsTest
{
    /**
     * Default constructor for test class NumberTheoryProblemsTest
     */
    public NumberTheoryProblemsTest()
    {
    }
